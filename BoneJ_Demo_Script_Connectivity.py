...
for txt in ROINRRD:
    ...
    tempdir = "/gpfs_projects_old/sriharsha.marupudi/Connectivity_Measurements_L1"
    ...
    macro_file = "/gpfs_projects_old/sriharsha.marupudi/Connectivity_API.py"
    ...
    #print(img,header)
    # with open(f"/gpfs_projects_old/sriharsha.marupudi/Connectivity_Measurements/ROI-{NAME}-table.csv", encoding = "utf8", errors = 'ignore') as file:
