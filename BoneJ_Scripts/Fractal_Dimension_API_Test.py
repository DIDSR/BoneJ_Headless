...
wrapper = cs.run("org.bonej.wrapperPlugins.FractalDimensionWrapper", False, ["inputImage",output,"startBoxSize",startBoxSize,"smallestBoxSize",smallestBoxSize,"scaleFactor",scaleFactor,"autoParam",autoParam])
