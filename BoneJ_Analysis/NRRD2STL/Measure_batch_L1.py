...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 23 17:54:42 2022
...
if __name__ == "__main__":
        ...
        files = glob(ROIDir+"ROI_*.nrrd")
        with open("/gpfs_projects/sriharsha.marupudi/ROI_3D_Print_L1.txt") as in_files:
            for txt in in_files:
                ...
                img,header = nrrd.read(f"/gpfs_projects/sriharsha.marupudi/Segmentations_Otsu_L1/Segmentation-grayscale-{NAME}.nrrd")
